...
var myPluginCallback = function (fastify, options, done) {
    fastify.decorateRequest('myPluginProp', 'super-secret-value');
    fastify.decorateReply('myPluginProp', options.myPluginOption);
    done();
};
// define plugin using promises
var myPluginAsync = function (fastify, options) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        fastify.decorateRequest('myPluginProp', 'super-secret-value');
        fastify.decorateReply('myPlugingProp', options.myPluginOption);
        return [2 /*return*/];
    });
}); };
exports.default = (0, fastify_plugin_1.default)(myPluginCallback, '3.x');
